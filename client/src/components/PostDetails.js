...
const mapStateToProps = ({ posts, comments }, ownProps) => ({
  ...
  post: posts.filter(item => item.id === ownProps.match.params.postId && item.deleted !== true)[0],
});

export default withRouter(connect(mapStateToProps, { getPosts, getComments })(PostDetails));
